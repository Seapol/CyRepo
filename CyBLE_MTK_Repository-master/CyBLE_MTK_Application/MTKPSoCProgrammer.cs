...
namespace CyBLE_MTK_Application
{
    ...
    public class MTKPSoCProgrammer : MTKTest
    {
        ...
        void Event_UpdateProgressBar(int value, int max)
        {
            ...
            NumTestStatusUpdate(value.ToString() + "/" + max.ToString());
        }
        ...
        public bool ProgramAll()
        {
            ...
            {
                Log.PrintLog(this, "Initializing programmer failure.", LogDetailLevel.LogRelevant);
                return false;
            }
            ...
            if (!IsSuccess(hr))
            {
                ...
                //MessageBox.Show(errString, "Programming Error");
        ...
        public override MTKTestError RunTest()
        {
            ...
            if (!ConnectProgrammer())
            {
                ...
                RetVal = MTKTestError.NotAllDevicesProgrammed;
            ...
            else if(RetVal == MTKTestError.IgnoringDUT|| RetVal == MTKTestError.ProgrammerNotConfigured)
            {
                TestStatusUpdate(MTKTestMessageType.Complete, "IGNORE");
        ...
        public void ResetDevice()
        {
            ...
            Programmer.ToggleReset(0, 5, out mErrorString);
        }
